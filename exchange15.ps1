    ...
    Else {
      ...
      Switch ($State["InstallPhase"]) {
        ...
        5 {
            ...
            Set-TransportService $DAG1 -ConnectivityLogPath "D:\ExchangeServer\V15\TransportRoles\Logs\Hub\Connectivity" -ConnectivityLogMaxFileSize 10MB -ConnectivityLogMaxDirectorySize 1GB -ConnectivityLogMaxAge 30.00:00:00
